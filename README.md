...
The application requires only npm install and npm start or npm run dev to launch. Run npm test to run the tests.
## Data
...
//Reference: Udacity React-Redux-project documentation starter git.
